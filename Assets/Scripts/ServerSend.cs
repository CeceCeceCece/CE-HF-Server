...
public class ServerSend
{
    ...
    public static void SpawnPlayer(int _toClient, RigidbodyPlayer _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.spawnPlayer))
        {
            _packet.Write(_player.id);
    ...
    public static void PlayerPosition(RigidbodyPlayer _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.playerPosition))
        {
            _packet.Write(_player.id);
    ...
    public static void PlayerRotation(RigidbodyPlayer _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.playerRotation))
        {
            _packet.Write(_player.id);
    ...
    public static void PlayerHealth(RigidbodyPlayer _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.playerHealth))
        {
            _packet.Write(_player.id);
            _packet.Write(_player.CharacterType.health);
    ...
    public static void PlayerRespawned(RigidbodyPlayer _player)
    {
        using (Packet _packet = new Packet((int)ServerPackets.playerRespawned))
        {
            _packet.Write(_player.id);
